...
class _DriverTrackTruckScreenState extends State<DriverTrackTruckScreen> {
  ...
  String _calculateEstimatedEnd() {
    if (_startTime == "--:--" || _lastSessionData == null) {
      ...
      children: [
        ...
        _buildInfoCard(
          ...
          content: [
            ...
            const Divider(height: 24),
            _buildInfoRow("Last Update", _lastLocalPos != null ? DateFormat('hh:mm:ss a').format(_lastLocalPos!.timestamp) : "Waiting..."),
          ],
        ),
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              const SizedBox(width: 8),
              Text("Strong", style: TextStyle(fontWeight: FontWeight.w900, color: Colors.green, fontSize: statusFontSize)),
            ],
          ),
        ),
      ],
  ...
  Widget _buildMapControls() {
    return Positioned(
      bottom: widget.isEmbedded ? 20 : 240,
      right: 20,
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          _HoverZoomLink(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: (_isFollowLocked || _isTargetActive) ? const Color(0xFF00C853) : Colors.white,
                shape: BoxShape.circle,
                boxShadow: AppTheme.pulidongShadow,
              ),
              child: Icon(
                _isFollowLocked ? Icons.gps_fixed_rounded : Icons.gps_not_fixed_rounded,
                color: (_isFollowLocked || _isTargetActive) ? Colors.white : const Color(0xFF1A1A1A),
          ...
          _HoverZoomLink(
            ...
            child: Container(
              width: widget.isEmbedded ? 48 : 64, height: widget.isEmbedded ? 48 : 64,
              decoration: BoxDecoration(
                color: _isMapActive ? const Color(0xFF00C853) : Colors.white,
                shape: BoxShape.circle,
                boxShadow: AppTheme.pulidongShadow,
              ),
              child: Icon(
                Icons.map_outlined, 
                color: _isMapActive ? Colors.white : const Color(0xFF1A1A1A), 
                size: widget.isEmbedded ? 24 : 28
              ),
            ),
          ),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Real-time GPS connected", 
                      style: TextStyle(fontSize: subFontSize, color: Colors.grey.shade600, fontWeight: FontWeight.w700)
                    ),
                  ],
                ),
              ),
