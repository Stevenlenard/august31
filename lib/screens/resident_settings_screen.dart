...
class _ResidentSettingsScreenState extends State<ResidentSettingsScreen> with TickerProviderStateMixin {
  ...
  void _showStyledBottomSheet({required String title, required List<Widget> children, String? description, double maxHeightMultiplier = 0.6, bool needsLoading = false}) {
          ...
          builder: (context, setModalState) {
            ...
            return Dialog(
              ...
              child: AnimatedContainer(
                ...
                constraints: BoxConstraints(maxWidth: 550, maxHeight: isModalLoading ? 280 : 600),
                child: Container(
                  padding: const EdgeInsets.all(32),
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
        ...
        builder: (context, setModalState) {
          ...
          return Container(
            ...
            child: AnimatedContainer(
              duration: const Duration(milliseconds: 400),
              curve: Curves.easeInOutCubic,
              constraints: BoxConstraints(maxHeight: isModalLoading ? 280 : MediaQuery.of(context).size.height * maxHeightMultiplier),
