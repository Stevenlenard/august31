  ...
  Future<void> _downloadFile(String? url) async {
    ...
    try {
      if (await canLaunchUrl(uri)) {
        ...
        if (mounted) {
          CustomNotification.showTopNotification(context, "Download started successfully.", false);
        }
      } else {
        throw "Could not launch download tool.";
      }
    } catch (e) {
      if (mounted) {
                ...
                Listener(
                  ...
                  child: Column(
                    children: [
                      ...
                      // FIXED TOP SECTION
                      Padding(
                        padding: EdgeInsets.fromLTRB(isMobile ? 16 : 48, 8, isMobile ? 16 : 48, 0),
                        child: Center(
                          child: Container(
                                          ...
                                          child: SizedBox(
                                            ...
                                            child: Column(
                                              children: [
                                                ...
                                                Expanded(
                                                  child: _isLoading 
                                                    ? const Center(child: Padding(padding: EdgeInsets.all(40), child: CircularProgressIndicator(color: Color(0xFF00897B))))
