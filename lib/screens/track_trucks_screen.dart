...
class _TrackTrucksScreenState extends State<TrackTrucksScreen> with TickerProviderStateMixin {
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          if (!widget.isEmbedded) _buildDebugOverlay(),
          AnimatedPositioned(
            ...
            child: Center(
              child: PointerInterceptor(
                child: GestureDetector(
                  ...
                  child: Container(
                    width: 24, height: 80,
                    decoration: BoxDecoration(color: const Color(0xFF00695C), borderRadius: const BorderRadius.horizontal(left: Radius.circular(8)), boxShadow: AppTheme.pulidongShadow),
  ...
  Widget _buildDebugOverlay() {
    ...
    return Positioned(
      top: isDesktop ? 125 : 155, left: isDesktop ? 24 : 16,
      child: Container(
        padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 8),
        decoration: BoxDecoration(color: Colors.white.withOpacity(0.9), borderRadius: BorderRadius.circular(16), boxShadow: AppTheme.pulidongShadow, border: Border.all(color: Colors.white, width: 1.5)),
          ...
          builder: (context, setModalState) {
            return AnimatedContainer(
              ...
              constraints: BoxConstraints(
                maxHeight: MediaQuery.of(context).size.height * (isModalLoading ? 0.4 : 0.8),
              ),
