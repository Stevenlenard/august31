    ...
    return Scrollbar(
      child: SingleChildScrollView(
        ...
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            const SizedBox(height: 12), // Adds padding at the top of content area
            ...
            const SizedBox(height: 12), // Reduced spacing between input fields
            _buildValidatedField(
              label: "Full Name", 
              controller: nameCtrl, 
              focusNode: nameFocus, 
            ...
            const SizedBox(height: 24), // Reduced from 48 to make it "sakto"
            HoverActionButton(
              text: "Save Changes",
            ...
            const SizedBox(height: 8), // Minimal bottom buffer
          ],
        ),
      ),
    );
  ...
  Widget _buildValidatedField({
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 5), // Reduced space between title and field
        AnimatedContainer(
